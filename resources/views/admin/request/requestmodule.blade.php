...
@section('content')
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
     <nav class="navbar navbar-expand-lg  navbar-dark bg-dark mt-3">
        <a class="navbar-brand text-center pl-5 pr-5" href="{{ url('/admin/requestview') }}">Request</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav mt-3">
          <ul class="navbar-nav">
            <li class="nav-item active ml-2">
              <a class="nav-link" href="{{ url('/admin/requestview') }}">Request Intro <span class="sr-only">(current)</span></a>
            </li>

             <li class="nav-item active ml-2">
              <a class="nav-link" href="{{ url('/admin/requestmodule') }}">Request module
              ...
              <div class="card overflow-hidden">
                  ...
                  <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        <!-- Modal -->
                        <div class="modal fade bd-example-modal-lg" id="serviceintropage" tabindex="-1" role="dialog" aria-labelledby="serviceintropageLongTitle" aria-hidden="true">
                            <div class="modal-dialog modal-lg" role="document">
                              <div class="modal-content rounded-0">
                                ...
                                <div class="modal-body">
                                    ...
                                    <input type="hidden" class="form-control" id="title" name="title" value="{{$pagemodules->title}}" aria-describedby="title" placeholder="Title" required>
                                    ...
                                    <input type="hidden" name="redirceturl" value="/admin/requestmodule">
