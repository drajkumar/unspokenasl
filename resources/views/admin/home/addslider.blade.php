...
@section('content')
  <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
		<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
			<h2 class="h2">Add home slider</h2>
      ...
      @csrf
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="url" name="url" value="{{ old('url') }}" aria-describedby="url" placeholder="Enter Url" required>
        </div>
        ...
        <input type="hidden" name="pagename" value="slider">
      </div>
