...
@section('title','Legal Interpreting')
...
@section('mainContent')
 ...
 <!-- Breadcrumbs -->
	  ...
	  <section class="section section-lg text-center pb-0" >
        <div class="container">
          <h3 class="wow-outer"><span class="wow slideInUp"> <b>Legal Interpreting</b></span></h3>
	    </div>
      </section>
     ...
     ?>
	  ...
	  <section class="section section-lg text-center py-0" >
        <div class="container">
              <h4 class="wow-outer"><span class="wow slideInUp" style="visibility: visible; animation-name: slideInUp;">If you're interested in learning about the laws in place to protect people with disabilities within the legal setting, below are a few provided resources:</span></h4>
        ...
        <section class="section-lg text-center">
          <div class="container">
            <h4 class="wow-outer"><span class="wow slideInUp">Unspoken Language Services specialize in the following Legal settings:</span></h4>
          ...
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-sm-10 col-lg-7 col-xl-7">
                <h4 class="wow-outer"><span class="wow slideInDown" style="visibility: visible; animation-name: slideInDown;">Need a Legal Interpreter?</span></h4>
				<p class="wow-outer offset-top-3"><span class="wow slideInDown" data-wow-delay=".05s" style="visibility: visible; animation-delay: 0.05s; animation-name: slideInDown;">Let us serve your Legal Interpreting accommodations.</span></p>
